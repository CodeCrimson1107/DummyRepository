...
,(YEAR(VCH_TO_DATE)*100+MONTH(VCH_TO_DATE)) as "CommYYYYMM"
...
--AND VCH_GROUP_CODE 
AND VCH_FROM_DATE >= ''2022-03-01''
--AND VCH_TO_DATE = ''2022-03-01''
--AND VCH_TRANS_DATE = ''2022-03-31''
ORDER BY 4,5 DESC
')