...
From (SELECT COUNT(TOTPREM) AS QUOTES, CO_Name as Company, SUM(TOTPREM) AS TOTAL_PREMIUM, RiskArea AS RISKAREA, P_Level AS P_LEVEL,
  ...
  WHERE (Rate_Yr*100+Rate_Mo) >= 201911  and LiabLimits101 >=15 AND LiabLimits101<=30 and LiabLimits301 >=10 AND LiabLimits301<=30 
...
From (SELECT COUNT(TOTPREM) AS QUOTES, CO_Name as Company, SUM(TOTPREM) AS TOTAL_PREMIUM, RiskArea AS RISKAREA, P_Level AS P_LEVEL,
              Rate_Yr AS QUOTE_YEAR, Rate_Mo AS QUOTE_MM,  [Profile],  TERM, 'OH' AS [STATE],  (Rate_Yr*100+Rate_Mo) as yyyymm1,
                     CASE WHEN ( left(rank1co,4) <> left(co_name,4) ) then (TOTPREM - RANK1PR)
                     WHEN ( left(RANK2CO,4) <> left(co_name,4) ) then (TOTPREM - RANK2PR)
                     WHEN ( left(RANK3CO,4) <> left(co_name,4) ) then (TOTPREM - RANK3PR)
                     WHEN ( left(RANK4CO,4) <> left(co_name,4) ) then (TOTPREM - RANK4PR)
...
From (SELECT COUNT(TOTPREM) AS QUOTES, CO_Name as Company, SUM(TOTPREM) AS TOTAL_PREMIUM,  RiskArea AS RISKAREA, P_Level AS P_LEVEL,
  ...
  WHERE (Rate_Yr*100+Rate_Mo) >= 201911  and LiabLimits101 >=25 AND LiabLimits101<=30 and LiabLimits301 >=10 AND LiabLimits301<=30 
  GROUP BY CO_Name, TOTPREM, RiskArea, P_Level, Rate_Yr , Rate_Mo,  [Profile], Term, 
             CASE WHEN ( left(rank1co,4) <> left(co_name,4) ) then (TOTPREM - RANK1PR)
                     WHEN ( left(RANK2CO,4) <> left(co_name,4) ) then (TOTPREM - RANK2PR)
                     WHEN ( left(RANK3CO,4) <> left(co_name,4) ) then (TOTPREM - RANK3PR)
...
From (SELECT COUNT(TOTPREM) AS QUOTES, CO_Name as Company, SUM(TOTPREM) AS TOTAL_PREMIUM,  RiskArea AS RISKAREA, P_Level AS P_LEVEL,
  ...
  WHERE (Rate_Yr*100+Rate_Mo) >= 201911  and LiabLimits101 >=25 AND LiabLimits101<=30 and LiabLimits301 >=25 AND LiabLimits301<=30  
  GROUP BY CO_Name, TOTPREM, RiskArea, P_Level, Rate_Yr , Rate_Mo,  [Profile], Term,
                CASE WHEN ( left(rank1co,4) <> left(co_name,4) ) then (TOTPREM - RANK1PR)
                     WHEN ( left(RANK2CO,4) <> left(co_name,4) ) then (TOTPREM - RANK2PR)
                     WHEN ( left(RANK3CO,4) <> left(co_name,4) ) then (TOTPREM - RANK3PR)
...
From (SELECT COUNT(TOTPREM) AS QUOTES, CO_Name as Company, SUM(TOTPREM) AS TOTAL_PREMIUM,  RiskArea AS RISKAREA, P_Level AS P_LEVEL,
  ...
  WHERE (Rate_Yr*100+Rate_Mo) >= 201911  and LiabLimits101 >=25 AND LiabLimits101<=30 and LiabLimits301 >=15 AND LiabLimits301<=30 
...
From (SELECT COUNT(TOTPREM) AS QUOTES, CO_Name as Company, SUM(TOTPREM) AS TOTAL_PREMIUM,  RiskArea AS RISKAREA, P_Level AS P_LEVEL,
  ...
  WHERE (Rate_Yr*100+Rate_Mo) >= 201911   and  LiabLimits101 >=25 AND LiabLimits101<=30 and LiabLimits301 >=20 AND LiabLimits301<=30 
  GROUP BY CO_Name, TOTPREM, RiskArea, P_Level, Rate_Yr , Rate_Mo,  Term, 
               CASE WHEN ( left(rank1co,4) <> left(co_name,4) ) then (TOTPREM - RANK1PR)
                     WHEN ( left(RANK2CO,4) <> left(co_name,4) ) then (TOTPREM - RANK2PR)
                     WHEN ( left(RANK3CO,4) <> left(co_name,4) ) then (TOTPREM - RANK3PR)
...
From (SELECT COUNT(TOTPREM) AS QUOTES, CO_Name as Company, SUM(TOTPREM) AS TOTAL_PREMIUM,  RiskArea AS RISKAREA, P_Level AS P_LEVEL,
  ...
  WHERE   LiabLimits101 >=25 AND LiabLimits101<=30 and LiabLimits301 >=25 AND LiabLimits301<=30 
...
From (SELECT COUNT(TOTPREM) AS QUOTES, CO_NAME AS COMPANY, SUM(TOTPREM) AS TOTAL_PREMIUM,  RISKAREA, P_LEVEL, 
  ...
  where  Rate_Yr*100 + Rate_Mo<=201910
